...
import dev.slne.surf.eventbus.redis.request.RequestResponseBus.Companion.DEFAULT_TIMEOUT_MS
 ...
 *
 * ## Lifecycle
 * The owning [dev.slne.surf.eventbus.redis.RedisApi] initializes the bus during startup via [init]
