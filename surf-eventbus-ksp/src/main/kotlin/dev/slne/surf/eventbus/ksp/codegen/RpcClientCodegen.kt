...
class RpcClientCodegen(
    ...
    private fun createConstructor(service: ServiceModel): FunSpec {
    ...
    private fun createDescriptorProperty(service: ServiceModel): PropertySpec {
    ...
    private fun createFunctionParameters(function: ServiceFunctionModel): List<ParameterSpec> {
