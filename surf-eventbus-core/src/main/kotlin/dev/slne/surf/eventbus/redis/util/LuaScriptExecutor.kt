...
class LuaScriptExecutor private constructor(
    private val api: SurfRedisApi,
    private val registry: LuaScriptRegistry,
) {
    ...
    private fun getSha(id: String): Mono<String> =
        scriptShas.computeIfAbsent(id) {
    ...
    companion object {
        ...
        private val byApi =
            Caffeine
                ...
                .weakKeys()
                .weakValues()
                .build<SurfRedisApi, LoadingCache<LuaScriptRegistry, LuaScriptExecutor>> { api ->
                    Caffeine
                        .newBuilder()
                        .weakKeys()
                        .weakValues()
